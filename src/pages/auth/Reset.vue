<template>
    <q-page class="window-height window-width row justify-center items-center">
        <div class="column">
            <div class="row">
                <h5 class="text-h5 text-white q-my-md">Password Reset</h5>
            </div>
            <div class="row">
                    ...
                    <q-card-section>
                        <q-form class="q-gutter-lg">
                            ...
                            <q-input square filled clearable v-model="password_confirm" type="password"
                                label="Confirm password" color="orange" />
                        </q-form>
                    </q-card-section>
...
onMounted(() => {
    ...
    // If the token is not empty, set the token else redirect to login
